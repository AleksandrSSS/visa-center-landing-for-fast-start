...
links.forEach(item => {
  (item.href === window.location.href )
    ? item.parentNode.classList.add('menu-active')
    : item.parentNode.classList.remove('menu-active')
})
/* =============================== */
/* =========== pop-up ============ */
/* =============================== */
...
/* 
1. http://intuit.ru:80/r/dir/page?search#mark
2. window.location.href = [url]http://intuit.ru:80/r/dir/page?search#mark[/url]
3. window.location.protocol = http;
4. window.location.hostname = intuit.ru;
5. window.location.host = intuit.ru:80;
6. window.location.port = 80
7. window.location.pathname = /r/dir/;
8. window.location.search = search;
9. window.location.hash = mark;
======
...
/*
    //  Start Google map  // When the window has finished loading create our google map below
if(document.getElementById("map")){
  ...
  function init() {
      ...
      var mapOptions = {
          ...
          center: new google.maps.LatLng(50.454, 30.523), // New York
